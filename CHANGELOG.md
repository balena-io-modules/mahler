...
* Update dependency tar-stream to v3.1.7 [balena-renovate[bot]]

# v4.1.4
## (2025-03-19)

* Update dependency @types/tar-stream to v2.2.3 [balena-renovate[bot]]

# v4.1.3
## (2025-02-10)

* Move noUncheckedIndexAccess to release tsconfig [Felipe Lalanne]
* Keep comments on TS builds [Felipe Lalanne]
...
* Remove `logger` property of AgentOpts [Felipe Lalanne]
* Move state rollback to Agent runtime [Felipe Lalanne]
